...
| 세부기능 ID | 기능 | FE 처리 기준 |
| --- | --- | --- |
| `MYPAGE-001` | 내 정보 조회/수정 | 내 정보 화면에서는 개인정보를 확인하고, 기본 정보와 선호 스타일을 수정합니다. 프로필 이미지, 자기소개, 외부 링크는 룩피드 프로필 편집 흐름에서 수정합니다. |
...
- 기본 정보 수정, 선호 스타일 수정, 룩피드 프로필 수정 중 저장하지 않은 변경이 있으면 작성 중 이탈 확인 모달을 표시합니다.
- 프로필 이미지 수정은 룩피드 프로필 편집 흐름에서 파일을 업로드한 뒤, 서버가 반환한 이미지 URL을 프로필 저장 요청에 반영합니다.
- 프로필 이미지, 자기소개, 외부 링크 수정은 룩피드 프로필 편집 흐름에서 처리합니다.
