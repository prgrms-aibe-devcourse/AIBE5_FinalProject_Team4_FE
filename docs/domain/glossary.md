...
| 옷장 등록 옷 | 특정 사용자의 옷장과 공통 옷 정보를 연결한 사용자별 옷 데이터입니다. 보유/미보유, 사이즈, 계절, 즐겨찾기 등은 여기에 저장합니다. | `WARDROBE_CLOTHES` |
| 공통 옷 정보 | 옷 자체의 공통 정보입니다. 상품명, 브랜드, 품번, 대표 이미지, 카테고리, 타입, 대상 성별, 출처 정보를 저장합니다. | `CLOTHES` |
